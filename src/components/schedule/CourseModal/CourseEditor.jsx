...
const CourseEditor = ({
  ...
  return (
    <div
      className="mt-4 rounded-2xl p-4 bg-surface-low"
    >
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="text-xs font-medium transition-colors text-on-surface-variant"
        >
          取消
        </button>
      </div>
      ...
      {errors.length > 0 && (
        <div
          className="mt-2 text-xs rounded-xl p-3 space-y-1 bg-error-container text-error-on-container"
        >
      ...
      <div className="mt-3 space-y-4">
        ...
        <input
          ...
          className="w-full px-4 py-2.5 rounded-xl text-sm bg-surface-low border-soft text-on-surface focus:ring-2 focus:outline-none focus:ring-primary/40"
          placeholder="如：儿科学A"
        />
        ...
        <div>
          <div className="text-xs font-semibold mb-2 text-on-surface-variant">
            选修归属（可选 / 可多选）
          </div>
                ...
                <button
                  ...
                  style={
                    isSelected
                      ...
                      : { backgroundColor: "#F3EDF7", color: "#1D192B" }
                  }
                >
                  {option.label}
                </button>
          ...
          {normalizedAllowedWeeks.length > 1 && currentWeek != null && (
            <div className="flex gap-2 mb-2">
              <button
                ...
                className="px-3 py-1 rounded-full text-xs font-semibold transition-colors bg-surface-mid text-primary-on-container"
              >
                仅第{currentWeek}周
              </button>
              <button
        ...
        <div>
          <div className="text-xs font-semibold mb-1 text-on-surface-variant">上课地点</div>
          <input
            type="text"
            value={location}
        ...
        <div>
          <div className="text-xs font-semibold mb-1 text-on-surface-variant">
            备注
          </div>
          <input
            type="text"
        ...
        <div className="flex justify-end gap-2 pt-2">
          <button
            type="button"
            onClick={requestCancel}
            className="px-4 py-1.5 rounded-pill text-xs font-semibold transition-colors text-primary"
          >
            取消
          </button>
          <button
            type="button"
            onClick={handleSave}
            className="px-5 py-1.5 rounded-pill text-xs font-semibold transition-colors bg-primary text-on-primary"
          >
            保存
          </button>
        </div>
