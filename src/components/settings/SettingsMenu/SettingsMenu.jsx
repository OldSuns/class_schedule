      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-0 top-0 bottom-0 w-72 sm:w-80 z-50 overflow-y-auto flex flex-col shadow-elevated"
            style={{ backgroundColor: "var(--surface-primary)" }}
          >
            <div
              className="sticky top-0 z-10 flex justify-between items-center pt-[var(--safe-top)]"
              style={{
